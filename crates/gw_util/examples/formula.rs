...
// use gw_util::formula::types::Error;
// use gw_util::formula::*;
...
//         "A" => types::Value::String("TEXT".to_string()),
//         "B" => types::Value::Float(3.2),
...
//         "ONE" => types::Value::Float(params[0].as_float().unwrap() + 1.0),
//         "TWO" => types::Value::Float(params[0].as_float().unwrap() + params[1].as_float().unwrap()),
//         // _ => types::Value::Error(types::Error::Value),
//         _ => types::Value::Empty,
//     };
...
//     let custom_functions = |s: String, params: Vec<types::Value>| match s.as_str() {
//         "Increase" => types::Value::Float(params[0].as_float().unwrap() + 1.0),
//         "SimpleSum" => {
//             types::Value::Float(params[0].as_float().unwrap() + params[1].as_float().unwrap())
//         }
//         "EqualFive" => types::Value::Float(5.0),
//         // _ => return Err(types::Error::Value),
//         _ => types::Value::Empty,
//     };
...
//     let result =
//         calculate::calculate_formula(formula, Some(&custom_function), None::<NoReference>)?;
//     println!("Result is {}", calculate::result_to_string(result));
...
//     let data_function = |s: String| match s.as_str() {
//         "ReferenceKey" => types::Value::String("100".to_string()),
//         "ReferenceName" => types::Value::String("Test".to_string()),
//         // // _ => types::Value::Error(types::ErrorFloatValue),
//         _ => types::Value::Empty,
//     };
