...
// /// `BatchController`.
// pub struct BatchUncheckedWorld<'a>(pub &'a UnsafeWorld<'a>);
...
//     fn fetch(_access: &Self::Accessor, world: &UnsafeWorld<'a>) -> Self {
...
//     fn run(&mut self, world: &UnsafeWorld<'c>, dispatcher: &mut Dispatcher<'a, 'b>);
...
//         fn run(&mut self, world: &UnsafeWorld<'_>, dispatcher: &mut Dispatcher<'a, 'b>) {
//             for _i in 0..3 {
//                 dispatcher.dispatch(world);
//             }
//         }
