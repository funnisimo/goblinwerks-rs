...
/// [Example usage standalone.](https://github.com/bevyengine/bevy/blob/latest/crates/gw_ecs/examples/events.rs)
///
#[derive(Debug)]
...
impl<'w, 's, E: Event> EventReader<'w, 's, E> {
    ...
    ///     }
    /// }
    /// # gw_ecs::system::assert_is_system(play_collision_sound);
    /// ```
...
///
/// ```
/// # use gw_ecs::{prelude::*, event::Events};
///
/// # pub struct MyEvent;
