...
pub mod adapter {
    ...
    /// System adapter that utilizes the [`bevy_utils::println!`] macro to print system information.
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// System adapter that utilizes the [`bevy_utils::println!`] macro to print the output of a system.
    ///
    /// # Examples
    ///
    /// ```
