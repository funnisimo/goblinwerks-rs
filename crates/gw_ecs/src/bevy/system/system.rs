...
pub trait System: Send + Sync + 'static {
    ...
    /// Returns the resources the system reads (globals, resources, components).
    fn read(&self) -> Vec<ResourceId>;
    /// Returns the resources the system writes (globals, resources, components).
    fn write(&self) -> Vec<ResourceId>;
    ...
    fn default_system_sets(&self) -> Vec<Box<dyn crate::bevy::schedule::SystemSet>> {
        Vec::new()
    }
