...
///
/// The corresponding [`Schedule`](gw_ecs::schedule::Schedule) objects are added by [`App::add_default_schedules`].
...
impl CoreSchedule {
    ...
    pub fn outer_schedule() -> Schedule {
        ...
        schedule.set_executor_kind(gw_ecs::schedule::ExecutorKind::SingleThreaded);
...
///
/// The corresponding [`SystemSets`](gw_ecs::schedule::SystemSet) are added by [`App::add_default_schedules`].
///
...
pub enum CoreSet {
    ...
    PreUpdateFlush,
    /// Applies [`State`](gw_ecs::schedule::State) transitions
    StateTransitions,
